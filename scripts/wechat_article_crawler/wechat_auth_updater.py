...
async def refresh_wechat_auth(
    ...
    profile_dir: str = "./output/my_wechat_profile",
    headless: bool = False,
    target_url: Optional[str] = None,
    params_output_path: str = "output/wechat_params.json",
...
def main() -> None:
    ...
    parser.add_argument("--profile-dir", type=str, default="./output/my_wechat_profile")
    parser.add_argument("--headless", action="store_true")
    parser.add_argument("--target-url", type=str, default=None)
    parser.add_argument("--params-out", type=str, default="output/wechat_params.json")
