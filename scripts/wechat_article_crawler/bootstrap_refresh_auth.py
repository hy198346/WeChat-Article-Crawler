...
def _crawler_script() -> str:
    return str(_repo_root() / "scripts" / "wechat_article_crawler" / "wechat_crawler.py")
...
def main() -> None:
    ...
    profile_dir = os.environ.get("WECHAT_PROFILE_DIR", "./output/my_wechat_profile")
