...
export WECHAT_PUSH_LATEST_IGNORE_BATCH_FAILURE="${WECHAT_PUSH_LATEST_IGNORE_BATCH_FAILURE:-1}"
export WECHAT_PUSH_LATEST_PER_ACCOUNT_SLEEP_S="${WECHAT_PUSH_LATEST_PER_ACCOUNT_SLEEP_S:-2.2}"
export WECHAT_GLOBAL_FREQ_BREAK_CONSECUTIVE="${WECHAT_GLOBAL_FREQ_BREAK_CONSECUTIVE:-24}"
export WECHAT_GLOBAL_FREQ_BREAK_MIN_PROCESSED="${WECHAT_GLOBAL_FREQ_BREAK_MIN_PROCESSED:-12}"
export WECHAT_GLOBAL_ERROR_BREAK_CONSECUTIVE="${WECHAT_GLOBAL_ERROR_BREAK_CONSECUTIVE:-12}"
export WECHAT_GLOBAL_ERROR_BREAK_MIN_PROCESSED="${WECHAT_GLOBAL_ERROR_BREAK_MIN_PROCESSED:-10}"
export WECHAT_GLOBAL_AUTH_BREAK_CONSECUTIVE="${WECHAT_GLOBAL_AUTH_BREAK_CONSECUTIVE:-5}"
export WECHAT_GLOBAL_AUTH_BREAK_MIN_PROCESSED="${WECHAT_GLOBAL_AUTH_BREAK_MIN_PROCESSED:-6}"
