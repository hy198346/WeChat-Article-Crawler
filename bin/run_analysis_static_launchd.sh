...
export WECHAT_ANALYSIS_STATIC_HOST="${WECHAT_ANALYSIS_STATIC_HOST:-127.0.0.1}"
export WECHAT_ANALYSIS_STATIC_PORT="${WECHAT_ANALYSIS_STATIC_PORT:-8765}"

exec /usr/bin/python3 "$ROOT/scripts/wechat_article_crawler/wechat_crawler.py" --serve-analysis-static
